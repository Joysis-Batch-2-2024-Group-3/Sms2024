...
public class CourseView {
        ...
        static void DisplayCourseView() throws InterruptedException {
                ...
                while (running) {
                        ...
                        Sout(conc.center + conc.BB_WHITE + " " + conc.BB_BLACK + "\t\t\t\t\t\t" + conc.BR_GREEN
                                        + "C O U R S E   M E N U" + conc.BB_BLACK + "\t\t\t\t\t " + conc.BB_WHITE + " "
                                        + conc.RESET);
                        Sout(conc.whiteSpace);
                        Sout(conc.whiteLine);
                        Sout(conc.whiteSpace);
                        Sout(conc.center + conc.BB_WHITE + " " + conc.BB_BLACK + "\t\t\t\t\t" + conc.BR_BLUE
                                        + "[1] Display All Courses" + conc.BB_BLACK + "\t\t\t\t\t\t " + conc.BB_WHITE
                                        + " " + conc.RESET);
                        Sout(conc.center + conc.BB_WHITE + " " + conc.BB_BLACK + "\t\t\t\t\t" + conc.BR_BLUE
                                        + "[2] Search for Course/s" + conc.BB_BLACK + "\t\t\t\t\t\t " + conc.BB_WHITE
                                        + " " + conc.RESET);
                        Sout(conc.center + conc.BB_WHITE + " " + conc.BB_BLACK + "\t\t\t\t\t" + conc.BR_BLUE
                                        + "[3] Update for Courses" + conc.BB_BLACK + "\t\t\t\t\t\t " + conc.BB_WHITE
                                        + " " + conc.RESET);
                        Sout(conc.center + conc.BB_WHITE + " " + conc.BB_BLACK + "\t\t\t\t\t" + conc.BR_BLUE
                                        + "[4] Add Course"
                        ...
                        Sout(conc.center + conc.BB_WHITE + " " + conc.BB_BLACK + "\t\t\t\t\t" + conc.BR_BLUE
                                        ...
                                        + conc.BB_BLACK + "\t\t\t\t\t\t\t " + conc.BB_WHITE + " " + conc.RESET);
                        Sout(conc.center + conc.BB_WHITE + " " + conc.BB_BLACK + "\t\t\t\t\t" + conc.BR_BLUE
                                        + "[6] Back to Main Menu" + conc.BB_BLACK + "\t\t\t\t\t\t " + conc.BB_WHITE
                                        + " " + conc.RESET);
                        Sout(conc.whiteSpace);
                        Sout(conc.whiteLine);
                        ...
                        switch (choice) {
                                ...
                                case 2 -> {
                                        ...
                                        Sout(conc.center + conc.BB_WHITE + " " + conc.BB_BLACK + "\t\t\t\t\t"
                                                        + conc.BR_BLUE
                                                        + "F I L T E R   C O U R S E" + conc.BB_BLACK + "\t\t\t\t\t "
                                                        + conc.BB_WHITE + " "
                                                        + conc.RESET);
                                        Sout(conc.whiteSpace);
                                        Sout(conc.whiteLine);
                                        ...
                                        Sout(conc.center + conc.BB_WHITE + " " + conc.BB_BLACK + "\t\t\t\t\t\t"
                                                        + conc.BR_BLUE
                                                        + "[1] Course Name" + conc.BB_BLACK + "\t\t\t\t\t\t\t "
                                                        + conc.BB_WHITE + " " + conc.RESET);
                                        Sout(conc.center + conc.BB_WHITE + " " + conc.BB_BLACK + "\t\t\t\t\t\t"
                                                        + conc.BR_BLUE
                                                        + "[2] Department Name" + conc.BB_BLACK + "\t\t\t\t\t\t "
                                                        + conc.BB_WHITE + " "
                                                        + conc.RESET);
                                        Sout(conc.whiteSpace);
                                        Sout(conc.whiteLine);
                                        ...
                                        Sout(conc.center + conc.BB_YELLOW + " " + conc.BB_BLACK + "\t\t\t\t\t"
                                                        + conc.BR_YELLOW
                                                        + "Choose a column to filter by" + conc.BB_BLACK + "\t\t\t\t" +
                                        ...
                                        switch (option) {
                                                case 1 -> {
                                                        ...
                                                        Sout(conc.center + conc.BB_YELLOW + " " + conc.BB_BLACK
                                                                        + "\t\t\t\t\t" + conc.BR_YELLOW
                                                                        + "Enter the course name" + conc.BB_BLACK
                                                                        + "\t\t\t\t\t\t" +
                                                                        " " + conc.BB_YELLOW + " " + conc.RESET);
                                                        Sout(conc.yellowSpace);
                                                        Sout(conc.yellowLine);
                                                ...
                                                case 2 -> {
                                                        ...
                                                        Sout(conc.center + conc.BB_YELLOW + " " + conc.BB_BLACK
                                                                        + "\t\t\t\t\t" + conc.BR_YELLOW
                                                                        + "Enter the department name" + conc.BB_BLACK
                                                                        + "\t\t\t\t\t" +
                                                                        " " + conc.BB_YELLOW + " " + conc.RESET);
                                                        Sout(conc.yellowSpace);
                                                        Sout(conc.yellowLine);
                                ...
                                case 3 -> {
                                        ...
                                        Sout(conc.center + conc.BB_YELLOW + " " + conc.BB_BLACK + "\t\t\t\t\t\t"
                                                        + conc.BR_YELLOW
                                                        + "Enter the Course ID" + conc.BB_BLACK + "\t\t\t\t\t\t" +
                                                        " " + conc.BB_YELLOW + " " + conc.RESET);
                                        Sout(conc.yellowSpace);
                                        Sout(conc.yellowLine);
                                        System.out.print(conc.YELLOW + "\n" + conc.center + "\t\t\t\t\t\t\t"
                                ...
                                case 4 -> {
                                        ...
                                        Sout(conc.center + conc.BB_YELLOW + " " + conc.BB_BLACK + "\t\t\t\t\t\t"
                                                        + conc.BR_YELLOW
                                                        + "Enter department name" + conc.BB_BLACK + "\t\t\t\t\t" +
                                                        " " + conc.BB_YELLOW + " " + conc.RESET);
                                        Sout(conc.yellowSpace);
                                        Sout(conc.yellowLine);
                                        System.out.print(conc.YELLOW + "\n" + conc.center + "\t\t\t\t\t\t\t"
                                ...
                                case 5 -> {
                                        ...
                                        while (!isValidInput) {
                                                ...
                                                Sout(conc.center + conc.BB_WHITE + " " + conc.BB_BLACK + "\t\t\t\t"
                                                                + conc.BR_WHITE
                                                                + "D E L E T E   A   C O U R S E" + conc.BB_BLACK
                                                                + "\t\t\t\t\t" +
                                                                " " + conc.BB_WHITE + " " + conc.RESET);
                                                Sout(conc.center + conc.BB_YELLOW + " " + conc.BB_BLACK + "\t\t\t\t\t\t"
                                                                + conc.BR_YELLOW
                                                ...
                                                if (cc.validateBothName(values)) {
                                                        ...
                                                        Sout(conc.center + conc.BB_RED + " " + conc.BB_BLACK
                                                                        + "\t\t\t\t\t\t" + conc.BR_RED
                                                                        + "Course not found" + conc.BB_BLACK
                                                                        + "\t\t\t\t\t\t" +
                                                                        " " + conc.BB_RED + " " + conc.RESET);
                                                        Sout(conc.center + conc.BB_RED + " " + conc.BB_BLACK
                                                                        + "\t\t\t\t" + conc.BR_RED
                                        ...
                                        Sout(conc.center + conc.BB_YELLOW + " " + conc.BB_BLACK + "\t\t\t\t\t\t"
                                                        + conc.BR_YELLOW
                                                        + "Confirm Delete" + conc.BB_BLACK + "\t\t\t\t\t\t\t" +
                                                        " " + conc.BB_YELLOW + " " + conc.RESET);
                                        Sout(conc.center + conc.BB_YELLOW + " " + conc.BB_BLACK + "\t\t\t\t\t"
                                                        + conc.BR_WHITE
                                                        + values.get("course_name") + " "
                                                        + values.get("department_name") + " (Y/N)" + conc.BB_BLACK
                                                        + "\t\t\t\t" + " " + conc.BB_YELLOW + " " + conc.RESET);
                                        Sout(conc.yellowSpace);
                                        Sout("" + conc.yellowLine);
                                        Sout(conc.yellowSpace);
                                        Sout(conc.center + conc.BB_YELLOW + " " + conc.BB_BLACK + "\t\t\t\t\t"
                                                        + conc.BR_YELLOW
                                                        + "Enter 'Y' for Yes or 'N' for No" + conc.BB_BLACK + "\t\t\t\t"
                                                        +
                                                        " " + conc.BB_YELLOW + " " + conc.RESET);
                                        Sout(conc.yellowSpace);
                                        Sout(conc.yellowLine);
        ...
        static private void updateCourseField(int courseID) {
                ...
                while (updatingCourse) {
                        ...
                        Sout(conc.whiteSpace);
                        Sout(conc.center + conc.BB_WHITE + " " + conc.BB_BLACK + "\t\t\t\t\t" + conc.BR_BLUE
                                        + "Select Course Field to update" + conc.BB_BLACK + "\t\t\t\t " + conc.BB_WHITE
                                        + " " + conc.RESET);
                        Sout(conc.whiteSpace);
                        Sout(conc.center + conc.BB_WHITE + " " + conc.BB_BLACK + "\t\t\t\t\t" + conc.BR_BLUE
                                        + "[1] Course Name"
                                        + conc.BB_BLACK + "\t\t\t\t\t\t\t\t " + conc.BB_WHITE + " " + conc.RESET);
                        Sout(conc.center + conc.BB_WHITE + " " + conc.BB_BLACK + "\t\t\t\t\t" + conc.BR_BLUE
                                        + "[2] Course Department Name" + conc.BB_BLACK + "\t\t\t\t\t " + conc.BB_WHITE
                                        + " " + conc.RESET);
                        Sout(conc.center + conc.BB_WHITE + " " + conc.BB_BLACK + "\t\t\t\t\t" + conc.BR_BLUE
                                        + "[3] Finish Update"
                                        + conc.BB_BLACK + "\t\t\t\t\t\t\t " + conc.BB_WHITE + " " + conc.RESET);
