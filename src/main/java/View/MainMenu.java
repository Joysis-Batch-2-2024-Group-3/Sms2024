...
//    this function will return the user response, it should only accept 1 as valid response
    ...
    public static void DisplayActionsMenu() throws InterruptedException
    {
        ...
        System.out.println(cc.whiteLine);
        System.out.println(cc.whiteSpace);
        System.out.println(cc.center+cc.BB_WHITE+" "+cc.BB_BLACK+"\t\t\t\t\t\t  "+cc.BR_GREEN+"[1] Student"+cc.BB_BLACK+"\t\t\t\t\t\t\t "+cc.BB_WHITE+" "+cc.RESET);
        System.out.println(cc.center+cc.BB_WHITE+" "+cc.BB_BLACK+"\t\t\t\t\t\t  "+cc.BR_GREEN+"[2] Course"+cc.BB_BLACK+"\t\t\t\t\t\t\t "+cc.BB_WHITE+" "+cc.RESET);
        System.out.println(cc.center+cc.BB_WHITE+" "+cc.BB_BLACK+"\t\t\t\t\t\t  "+cc.BR_GREEN+"[3] Section"+cc.BB_BLACK+"\t\t\t\t\t\t\t "+cc.BB_WHITE+" "+cc.RESET);
        System.out.println(cc.center+cc.BB_WHITE+" "+cc.BB_BLACK+"\t\t\t\t\t\t  "+cc.BR_GREEN+"[4] Subject"+cc.BB_BLACK+"\t\t\t\t\t\t\t "+cc.BB_WHITE+" "+cc.RESET);
        System.out.println(cc.center+cc.BB_WHITE+" "+cc.BB_BLACK+"\t\t\t\t\t\t  "+cc.BR_GREEN+"[5] Schedule"+cc.BB_BLACK+"\t\t\t\t\t\t\t "+cc.BB_WHITE+" "+cc.RESET);
        System.out.println(cc.center+cc.BB_WHITE+" "+cc.BB_BLACK+"\t\t\t\t\t\t  "+cc.BR_GREEN+"[6] Student Subject"+cc.BB_BLACK+"\t\t\t\t\t "+cc.BB_WHITE+" "+cc.RESET);
        System.out.println(cc.center+cc.BB_WHITE+" "+cc.BB_BLACK+"\t\t\t\t\t\t  "+cc.BR_GREEN+"[7] Logout"+cc.BB_BLACK+"\t\t\t\t\t\t\t "+cc.BB_WHITE+" "+cc.RESET);
        System.out.println(cc.whiteSpace);
        System.out.println(cc.whiteLine);
